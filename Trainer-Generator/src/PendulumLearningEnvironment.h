#ifndef PENDULUM_LEARNING_ENVIRONMENT_H
#define PENDULUM_LEARNING_ENVIRONMENT_H
...
*/
class PendulumLearningEnvironment : public Learn::LearningEnvironment
{
private:
...
public:
	...
	*/
	PendulumLearningEnvironment(const std::vector<double>& actions) :
	...
	/**
	* \brief Copy constructor for the PendulumLearningEnvironment.
	*
	* Default copy constructor since all attributes are trivially copyable.
	*/
	PendulumLearningEnvironment(const PendulumLearningEnvironment& other) = default;
