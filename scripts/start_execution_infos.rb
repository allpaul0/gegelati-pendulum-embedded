...
# launch the program mainExecutionInfos 
...
dirs.each do |d|
    ...
    puts "\033[1;36mExecutionInfos for #{d}\033[0m"
    ...
    Dir.chdir('Trainer-Generator/bin') do
        ...
        trainor_compilation_string = "make ExecutionInfos"
        unless (verbose)
        ...
        Dir.chdir('Release') do
            ...
            system("./ExecutionInfos ../../../#{TPG_dir}/#{d}/CodeGen/best_root_pruned.dot #{seed}")# best root codeGen
            check_exit_status($?.to_i)
            
            # Results are automatically saved to the right folder in ExecutionInfos

            # # Save the results of the ExectionInfos into the concerned TPG dir
